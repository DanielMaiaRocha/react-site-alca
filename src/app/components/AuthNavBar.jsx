      ...
      <div className="container mx-auto px-4 py-1">
        <div className="flex items-center justify-between">
          ...
          <div className="mobile-menublock md:hidden">
            {!navbarOpen ? (
              <button
                ...
                className="flex items-center px-3 py-2 border rounded border-blac"
              >
                <svg
          ...
          <div className="flex flex-row">
            {session ? (
              <span className="hidden md:flex text-xl font-customFont3 mt-6 mr-4">
                Hello, {firstName}
              </span>
            ) : (
              <button
                ...
                id="loginbtn"
                className="bg-[#17a2b8] hover:bg-[#468089] rounded-md text-white font-semibold w-36 p-1"
              >
                Login
              </button>
            )}
            <div>
              <ProfileIcon
                profilePicture={
                  session.user.image || "/images/profile-bg.png"
                } // Usa a imagem do session
              />
            </div>
          </div>
        </div>
