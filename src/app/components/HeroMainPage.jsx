  ...
  return (
    ...
    <main className='grid grid-col-8 sm:grid-cols-2 items-center justify-center'>
        <div className='flex flex-col justify-center items-center ml-10 mt-10 md:ml-20'>     
            ...
            <p className='text-lg text-center justify-center items-center md:text-2xl text-zinc-700 font-semibold mx-auto py-10'>Welcome to DUBBER, where we redefine the art of voiceover with cutting-edge technology and unparalleled expertise. At DUBBER, we are passionate about bringing characters and stories to life through dynamic and immersive voice performances. Our platform merges the precision of advanced tools with the creativity of talented voice artists, ensuring that every project resonates with authenticity and impact.</p>
