...
const Card = () => {
  ...
  return (
    <div className='flex justify-center items-center -mt-20 mb-20 md:mr-96 md:mb-20 md:-mt-20'>
      <div className={`border-2 border-zinc-400 w-96 md:w-[60%] h-60 rounded-md relative`}>
        ...
        <div className='flex justify-end items-end mt-2 mr-1 md:mt-5 md:mr-3'>
            <button onClick={toggleColor}>
                <svg xmlns="http://www.w3.org/2000/svg" fill={isRed ? "red" : "none"} viewBox="0 0 24 24" stroke-width="1.5" stroke={isRed ? "red" : "currentColor"} className="w-6 h-6 md:w-7 md:h-7">
        ...
        <div className='-mt-5 ml-4 md:-mt-8 md:ml-5 flex flex-row'>
          ...
          <div className='flex flex-col justify-end -ml-[8rem] mr-2 -mb-[4.3rem] md:ml-20 md:-mb-[4rem] gap-3'>
            <button className='bg-zinc-200 border-2 solid border-black hover:bg-zinc-300 rounded-md w-32 p-1 text-lg font-medium'>Chat</button>
            <button className='bg-[#17a2b8] border-2 solid border-black hover:bg-[#468089] rounded-md w-32 p-1 text-lg font-medium text-white'>Appoint</button>
          </div>
        </div>
      </div>
    </div>
