              ...
              <div className="tab-content">
                ...
                {activeTab === "account-info" && (
                  <div className="tab-pane fade" id="account-info">
                    <div className="form-group mt-4">
                      <label className="form-label block">
                        Postal code <span className="font-bold">*</span>
                      </label>
                      <input
                        type="text"
                        className="form-control w-96 px-3 py-2 border border-gray-300 rounded-md"
                    ...
                    <div className="form-group mt-4">
                      <label className="form-label block">
                        Street Name <span className="font-bold">*</span>
                      </label>
                      <input
                        type="text"
                        className="form-control w-96 px-3 py-2 border border-gray-300 rounded-md"
                        placeholder="5200 Street"
                      />
                    </div>

                    <div className="form-group mt-4">
                      <label className="form-label block">
                        Number <span className="font-bold">*</span>
                      </label>
                      <input
                        type="text"
                        className="form-control w-96 px-3 py-2 border border-gray-300 rounded-md"
                  ...
                  <div className="tab-pane fade" id="account-social-links">
                    <div className="card-body pb-2">
                      <div className="form-group mb-4 w-[30rem]">
                        <label className="form-label block">Operational Sistem</label>
                        <select className="form-control w-full px-3 py-2 border border-gray-300 rounded-md">
                          <option value="NA">Select a OP sistem</option>
                          <option value="WIN">Windows</option>
                          <option value="IOS">macOS</option>
                          <option value="LIN">Linux</option>
                        </select>
                      </div>
                      <div className="form-group mb-4 w-[30rem]">
                        <label className="form-label block">RAM memory</label>
                        <select className="form-control w-full px-3 py-2 border border-gray-300 rounded-md">
                          <option value="NA">Select</option>
                          <option value="WIN">4gb</option>
                          <option value="IOS">8gb</option>
                          <option value="LIN">16gb</option>
                          <option value="LIN">32gb</option>
                          <option value="LIN">64gb</option>
                          <option value="LIN">128gb</option>
                        </select>
                      </div>
                      <div className="form-group mb-4 w-[30rem]">
                        <label className="form-label block">Upload</label>
                        <input
                          type="text"
                          className="form-control w-full px-3 py-2 border border-gray-300 rounded-md"
                          placeholder="100mb/s"
                      ...
                      <div className="form-group mb-4 w-[30rem]">
                        <label className="form-label block">Download</label>
                        <input
                          type="text"
                          className="form-control w-full px-3 py-2 border border-gray-300 rounded-md"
                          placeholder="200mb/s"
                      ...
                      <div className="form-group mb-4 w-[30rem]">
                        <label className="form-label block">Browser</label>
                        <select className="form-control w-full px-3 py-2 border border-gray-300 rounded-md">
                          <option value="NA">Select a Browser</option>
                          <option value="WIN">Chrome</option>
                          <option value="IOS">Opera</option>
                          <option value="LIN">Safari</option>
                          <option value="LIN">Brave</option>
                          <option value="LIN">Edge</option>
                        </select>
                      </div>
                    </div>
                  </div>
